...
func newMachine(t *testing.T) *machinev1.Machine {
	...
	return &machinev1.Machine{ObjectMeta: metav1.ObjectMeta{Name: "machine-test"}, Spec: machinev1.MachineSpec{ProviderSpec: *providerSpec}}
}
...
func TestCredentialsSecretSuccess(t *testing.T) {
	...
	err := updateScope(controllerfake.NewFakeClient(credentialsSecret), &corev1.SecretReference{Name: "testCredentials", Namespace: "dummyNamespace"}, scope)
	if err != nil {
